...
public class FileUtils extends org.apache.commons.io.FileUtils {
	 ...
	 * @throws IOException
     */
	public static void creatImgFile(String imgPath,String imgName,MultipartFile file) throws IOException {
		Path realPath = Paths.get(imgPath);
		log.info(imgPath);
		if (!Files.exists(realPath)){
			log.info(realPath.toString()+"notExist");
			Files.createDirectories(realPath);
		}
		realPath = realPath.resolve(Paths.get(imgName));
		if (Files.exists(realPath)){
	...
	public static void readImg(HttpServletResponse response,String path)throws IOException{
